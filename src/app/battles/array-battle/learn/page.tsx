...
import {
  BookOpen, Play, CheckCircle, Lock, ChevronDown, Clock, Target
} from "lucide-react"
const tracks = [
  {
    id: "arrays",
...
export default function LearnPage() {
  ...
  const getTrackProgress = (track: typeof tracks[0]) => {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-teal-400 font-medium">4 of 21 lessons completed</span>
            </div>
            <div className="h-3 bg-gray-300 rounded-full overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-teal-500 to-green-500 rounded-full transition-all w-[19%]"
              />
            </div>
            <div className="mt-4 grid grid-cols-3 gap-4 text-center">
              ...
              <div>
                <div className="text-2xl font-bold text-gray-500">16</div>
                            ...
                            {track.lessons.map((lesson, j) => (
                              <div
                                ...
                                className={`flex items-center gap-4 p-4 rounded-xl transition-colors ${
                                  lesson.completed ? "bg-green-100" : "bg-gray-100 hover:bg-gray-200"
                                } cursor-pointer`}
                              >
                                ...
                                <div className="flex-1">
                                  <div className={`font-medium ${lesson.completed ? "text-green-400" : ""}`}>
                                    {lesson.title}
                                  </div>
                                </div>
