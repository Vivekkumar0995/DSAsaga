...
import {
  Search, Bookmark, BookmarkCheck, Clock,
  CheckCircle, Circle
} from "lucide-react"

const categories = [
  "All", "Array Fundamentals", "Two Pointers", "Sliding Window",
  "Binary Search", "Prefix Sum", "Kadane's Algorithm"
]
...
export default function PracticePage() {
  ...
  const [bookmarkedProblems, setBookmarkedProblems] = useState<number[]>(
    problems.filter(p => p.bookmarked).map(p => p.id)
  )
