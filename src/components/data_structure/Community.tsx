...
export function CommunitySection({ ds_param, testimonials, live_activity }: Data_Structure_Props) {
  return (
    <section className="relative z-10 py-24 px-4 sm:px-6 lg:px-8 bg-linear-to-b from-transparent via-green-950/10 to-transparent">
        ...
        <div className="text-center mb-16">
          ...
          >
            <h2 className="text-3xl sm:text-5xl font-bold text-gray-900 mb-4">
              Join the <span className="text-[#14b8a6]">{snakeToTitleCase(ds_param)} Community</span>
            </h2>
              ...
              {testimonials?.map((t, i) => (
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-10 h-10 rounded-full bg-linear-to-br from-teal-500 to-green-500 flex items-center justify-center text-black font-bold">
                      {t.avatar}
                    </div>
                    <div>
            ...
            <div className="bg-white shadow-sm border border-gray-200 rounded-xl p-4 space-y-4">
              {live_activity?.map((item, i) => (
                <div key={i} className="flex items-start gap-3 pb-4 border-b border-gray-200 last:border-0 last:pb-0">
                  ...
                  <div>
                    <p className="text-sm">
                      <span className="text-teal-600 font-medium">{item.user_name}</span>
