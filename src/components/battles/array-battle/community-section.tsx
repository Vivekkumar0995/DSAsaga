...
const liveActivity = [
  { user: "CodeNinja42", action: "won a ranked battle", time: "2m ago" },
  { user: "AlgoQueen", action: "completed Binary Search track", time: "5m ago" },
...
export function CommunitySection() {
  return (
    <section className="relative z-10 py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent via-green-950/10 to-transparent">
        ...
        <div className="text-center mb-16">
          ...
          >
            <h2 className="text-3xl sm:text-5xl font-bold text-gray-900 mb-4">
              Join the <span className="text-[#14b8a6]">Array Community</span>
            </h2>
              ...
              {testimonials.map((t, i) => (
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-teal-500 to-green-500 flex items-center justify-center text-black font-bold">
                      {t.avatar}
                    </div>
                    <div>
