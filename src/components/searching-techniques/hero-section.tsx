        ...
        >
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
            <Button
              ...
              asChild
            >
              <Link href="/searching-techniques/practice">
          ...
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              ...
              asChild
            >
              <Link href="/searching-techniques/battle">Join Battle</Link>
            </Button>
          </motion.div>
          ...
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              ...
              asChild
            >
              <Link href="/searching-techniques/learn">Explore Learning</Link>
            </Button>
          </motion.div>
        </motion.div>
