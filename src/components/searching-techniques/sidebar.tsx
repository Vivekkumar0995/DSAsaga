...
const navItems = [
  { name: 'Overview', href: '/searching-techniques', icon: LayoutGrid },
  { name: 'Battle', href: '/searching-techniques/battle', icon: Swords },
  { name: 'Practice', href: '/searching-techniques/practice', icon: Dumbbell },
  { name: 'Learn', href: '/searching-techniques/learn', icon: BookOpen },
  { name: 'Leaderboard', href: '/searching-techniques/leaderboard', icon: Trophy },
]
  ...
  return (
    <nav className="flex flex-col gap-2">
      {navItems.map((item) => {
        ...
        const isActive =
          pathname === item.href ||
          (item.href !== '/searching-techniques' && pathname.startsWith(item.href))
