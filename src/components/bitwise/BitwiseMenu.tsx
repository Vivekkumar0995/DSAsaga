...
const menuItems = [
  { href: "/bitwise", label: "Overview", icon: Home },
  { href: "/bitwise/battle", label: "Battle", icon: Zap },
  { href: "/bitwise/practice", label: "Practice", icon: Play },
  { href: "/bitwise/learn", label: "Learn", icon: BookOpen },
  { href: "/bitwise/leaderboard", label: "Leaderboard", icon: Award },
]
