...
const footerLinks = {
  Product: [
    { label: "Practice", href: "/bitwise/practice" },
    { label: "Battle", href: "/bitwise/battle" },
    { label: "Learn", href: "/bitwise/learn" },
    { label: "Leaderboard", href: "/bitwise/leaderboard" },
  ],
  Resources: [
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <Link href="/bitwise" className="flex items-center gap-2">
